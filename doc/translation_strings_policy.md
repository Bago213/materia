...
This document provides guidelines for internationalization of the Materia Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `materia_en.ts` remains unchanged.
