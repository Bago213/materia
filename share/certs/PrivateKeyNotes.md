...
unlocked to sign the Materia-Qt.app bundle.
...
allowing somebody to distribute a Materia-Qt.app or materia-qt-setup.exe with a valid
...
that the materia-qt.exe file inside the installer had not been tampered with.
