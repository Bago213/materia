 ...
 * between materiad, and materia-qt and non-server tools.
*/
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-conf=<file>", strprintf(_("Specify configuration file (default: %s)"), MATERIA_CONF_FILENAME));
    if (mode == HMM_MATERIAD)
    {
#ifndef WIN32
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), MATERIA_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/materia-project/materia>";
    const std::string URL_WEBSITE = "<https://materia.org>";
...
/** Sanity checks
 *  Ensure that Materia is running in a usable environment with all
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Make sure only a single Materia process is using the data directory.
