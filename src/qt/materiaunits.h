...
#ifndef MATERIA_QT_MATERIAUNITS_H
#define MATERIA_QT_MATERIAUNITS_H
...
/** Materia unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MateriaUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MateriaUnits(QObject *parent);

    /** Materia units.
      @note Source: https://en.materia.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MATER,
...
typedef MateriaUnits::Unit MateriaUnit;

#endif // MATERIA_QT_MATERIAUNITS_H
