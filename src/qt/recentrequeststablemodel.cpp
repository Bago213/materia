    ...
    if(role == Qt::DisplayRole || role == Qt::EditRole)
    {
        ...
        case Amount:
            if (rec->recipient.amount == 0 && role == Qt::DisplayRole)
                ...
                return MateriaUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount, false, MateriaUnits::separatorNever);
            else
                return MateriaUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rec->recipient.amount);
        }
    }
...
{
    return (this->walletModel->getOptionsModel() != NULL) ? tr("Requested") + " ("+MateriaUnits::name(this->walletModel->getOptionsModel()->getDisplayUnit()) + ")" : "";
}
