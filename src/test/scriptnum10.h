...
#ifndef MATERIA_TEST_SCRIPTNUM10_H
#define MATERIA_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Materia Core 0.10.0, for cross-comparison.
 */
public:
