...
#define BOOST_TEST_MODULE Materia Test Suite

#include "test_materia.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_materia_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
