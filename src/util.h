 ...
 */
#ifndef MATERIA_UTIL_H
#define MATERIA_UTIL_H
...
extern const char * const MATERIA_CONF_FILENAME;
extern const char * const MATERIA_PID_FILENAME;
...
{
    std::string s = strprintf("materia-%s", name);
