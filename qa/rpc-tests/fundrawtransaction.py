...
class RawTransactionsTest(MateriaTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid materia address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid materia address" in e.error['message'])
